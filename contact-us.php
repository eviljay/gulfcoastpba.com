...
<head>
    ...
    <meta name="description" content="If you have comments about our website or questions about the Gulf Coast PBA or Florida PBA, please feel free to contact us." />
	...
	<link rel="canonical" href="http://gulfcoastpba.com/contact-us.php">

    <title>Gulf Coast Police Benevolent Association | Contact Us</title>
	...
	<script src="http://battleplanmedia.com/js/script-formValidation.js" type="text/javascript"></script>
	...
	<div id="topPicCase">
		<div id="topPicBox">
			...
			<div id="picSlider">
				...
				<img src="images/photos/header2.jpg" data-thumb="images/photos/header2.jpg" /><img src="images/photos/header3.jpg" data-thumb="images/photos/header3.jpg" /><img src="images/photos/header4.jpg" data-thumb="images/photos/header4.jpg" /><img src="images/photos/header5.jpg" data-thumb="images/photos/header5.jpg" /><img src="images/photos/header1.jpg" data-thumb="images/photos/header1.jpg" />						
				</div>
			</div>
		...
		<div id="bodyBox">
			...
			<div id="rightCol">
				...
				<h2 class="headline">Contact Us</h2>
             	...
             	<form action="phpMail.php" method="post" name="contactForm" target="_top" id="contactForm" onsubmit="return validateForm();">
                        
                    <label>Name:</label>
                    <input name="Name" type="text" class="formBox" value="" size="40" maxlength="60" /><br/>
                    
                    <br/>
                    
                    
                    <label>Email:</label>
                    <input name="Email" type="text" class="formBox" value="" size="40" maxlength="60" /><br/>
                    
                    <br/>
                    
                    <label>Phone:</label>
                    <input name="Phone" type="text" class="formBox" value="" size="40" maxlength="60" /><br/>
                    
                    <br/><br/>
                    
                    <label class="comment">Comment or Question: </label><br/>
                    <textarea name="Message" cols="50" rows="8" class="commentBox"></textarea><br/>
                    
                    <div class="clearFloats"></div>
					<br/><br/>
                    
                    <center>
                    <span class="submit"><input name="reset" type="reset" value="Reset" /></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="submit"><input name="submit" type="submit" value="Submit" /></span>
                    </center>
				...
				<img src="images/photos/biz-front.jpg" width="542" height="313" class="leftPic" style="margin-top:0px;"/>
