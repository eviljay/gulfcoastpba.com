...
<head>
    ...
    <meta name="description" content="The Gulf Coast PBA is governed by a constitution and bylaws which can be accessed on this page via a PDF download." />
	...
	<link rel="canonical" href="http://gulfcoastpba.com/bylaws.php">

    <title>Gulf Coast Police Benevolent Association | Bylaws</title>
	...
	<div id="topPicCase">
		<div id="topPicBox">
			...
			<div id="picSlider">
				...
				<img src="images/photos/header3.jpg" data-thumb="images/photos/header3.jpg" /><img src="images/photos/header5.jpg" data-thumb="images/photos/header5.jpg" /><img src="images/photos/header2.jpg" data-thumb="images/photos/header2.jpg" /><img src="images/photos/header1.jpg" data-thumb="images/photos/header1.jpg" /><img src="images/photos/header4.jpg" data-thumb="images/photos/header4.jpg" />						
				</div>
			</div>
    ...
    <div id="bodyCase">
		<div id="bodyBox">
			...
			<div id="rightCol">
				...
				<h2 class="headline">Bylaws</h2>
				<p>WE, the sworn law enforcement officers in Lee County, Florida, do hereby associate ourselves for the following purposes:</p>
				

				<a href="pdf/gulfcoast-pba-bylaws.pdf" class="bodyLink" target="_blank"><img src="images/photos/bylaws.jpg" width="239" height="338" alt="" class="rightPic" style="margin-top:-10px;"/></a>


				<p>To support and defend the Constitution of the United States and the State of Florida; to inculcate loyalty and foster the impartial enforcement of law and order; to improve the individual
proficiency of our members in the performance of their duties; to encourage social and educational activities among our members; to create a tradition of esprit de corps, ensuring fidelity to duty under all conditions and circumstances; to cultivate a spirit of mutual helpfulness among our membership and the people we serve; to increase the efficiency of public service and thus more firmly establish the citizens' confidence in the public service that is dedicated to the protection of their lives and property.</p>

				<p>Please click <a href="pdf/gulfcoast-pba-bylaws.pdf" class="bodyLink" target="_blank">HERE</a> to download the complete constitution and bylaws on PDF.</p>
